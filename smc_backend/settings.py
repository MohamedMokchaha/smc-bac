...
CORS_ALLOW_ALL_ORIGINS = True  # Vérifiez cela pour la production
...
WSGI_APPLICATION = 'smc_backend.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = BASE_DIR / 'staticfiles'  # Utiliser un dossier séparé pour collectstatic
